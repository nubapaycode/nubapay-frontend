      ...
      <section className="flex flex-col gap-8 mb-14">
        ...
        <div className="flex flex-col gap-4">
          ...
          <label className="block">
            ...
            >
              <div className="overflow-hidden">
                <div className="mt-2 rounded-xl border border-gray-200 bg-[#0a0a0a] px-4 py-3">
                  <p className="text-[10px] text-[#7a9b7e] mb-2 font-medium">Vista previa en WhatsApp</p>
                  <div className="flex justify-end">
                    <div className="max-w-[290px] w-full rounded-lg overflow-hidden shadow-sm bg-[#004E36] px-3 pt-3 pb-2">
                      <div className="bg-[#003F2C] rounded-xl px-3 py-2.5 mb-1 border border-[#005a3f] mx-[-5px]">
